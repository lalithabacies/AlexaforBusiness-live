 ...
 * @return void
 */
function a4b_addon_analysis_register_addon_settings_tabs() {
  ...
  if ( ! is_null( $mlwQuizMasterNext ) && ! is_null( $mlwQuizMasterNext->pluginHelper ) && method_exists( $mlwQuizMasterNext->pluginHelper, 'register_quiz_settings_tabs' ) ) {
    $mlwQuizMasterNext->pluginHelper->register_addon_settings_tab( "Reporting And Analysis", 'qsm_addon_analysis_addon_settings_tabs_content' );
  }
}
 ...
 * @return void
 */
function a4b_addon_analysis_addon_settings_tabs_content() {
